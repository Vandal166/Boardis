...
public sealed class AddBoardMemberPermissionValidator : AbstractValidator<AddBoardMemberPermissionCommand>
{
    public AddBoardMemberPermissionValidator(IKeycloakUserService userService, IStringLocalizer<BoardResources> localizer)
    {
        RuleFor(x => x.BoardId)
            .NotEmpty()
